...
describe('Technician assignment', () => {
  ...
  it('assigns the selected real IDs and keeps submission disabled until selection', async () => {
    const done = vi.fn();
  ...
  it('explains an empty technician list', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Assign site visit' })).toBeDisabled();
  });
});
