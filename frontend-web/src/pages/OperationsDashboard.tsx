...
export function OperationsDashboard() {
  ...
  return <main style={{ display: 'grid', gap: 24 }}>
    <section className="glass-panel" style={{ padding: 32 }}><p style={{ color: '#287247', letterSpacing: 2 }}>SMART SOLAR · SRI LANKA</p><h1>Welcome, {user?.fullName}</h1><p>Coordinate rooftop solar surveys, field inspections, engineering review, and equipment preparation.</p></section>
