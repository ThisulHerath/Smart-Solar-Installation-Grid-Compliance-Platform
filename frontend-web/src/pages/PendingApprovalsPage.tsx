...
export const PendingApprovalsPage: React.FC = () => {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(
        e.message || 'Failed to load pending proposals.'
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Engineering proposals awaiting your decision
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>
            No proposals pending approval. All caught up!
          </p>
        </div>
      ) : (
        <>
          ...
          >
            <strong style={{ color: '#8b580b' }}>
              {proposals.length}
            </strong>{' '}
            proposal
            {proposals.length !== 1 ? 's' : ''} awaiting
            engineer decision.
          </p>
