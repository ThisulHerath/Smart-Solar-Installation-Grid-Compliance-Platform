...
export const FieldJobDetailPage: React.FC = () => {
  ...
  const [evaluationMsg, setEvaluationMsg] =
  ...
  const fetchJob = useCallback(async () => {
    ...
    try {
      ...
      setError(
        err.message ||
          'Failed to load field job details.',
      );
    } finally {
      setLoading(false);
    }
  ...
  if (loading) {
    return (
      ...
      >
        ...
        <div>
          Loading site inspection and compliance data...
        </div>
      </div>
    );
  }
    ...
    >
      ...
      {evaluationMsg && (
        <div
          ...
          style={{
            padding: '12px 18px',
            color: evaluationMsg.includes('failed')
              ? 'var(--solar-danger)'
              : 'var(--solar-emerald)',
            background: evaluationMsg.includes('failed')
              ? 'rgba(239, 68, 68, 0.1)'
              : 'rgba(16, 185, 129, 0.1)',
            display: 'flex',
            alignItems: 'center',
      ...
      >
        ...
        >
          <div>
            ...
            >
              Job ID: {job.id} &bull; Survey ID:{' '}
              {job.solarSurveyId} &bull; Assigned:{' '}
              {new Date(
                job.assignedAt,
              ).toLocaleString()}
            </p>
      ...
      {job.compliance ? (
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                CEB / LECO Grid Compliance Assessment
              </h2>
            </div>
          ...
          >
            ...
            >
              ...
              >
                {job.compliance.validationStatus ||
                  'PASSED'}
              </div>
            </div>
          ...
          {job.compliance.complianceNotes && (
            ...
            >
              ...
              >
                Compliance Engineering Findings &
                Directives
              </div>
        ...
        >
          ...
          <div>
            No compliance evaluation run yet. The
            technician must submit on-site telemetry or
            staff can trigger evaluation above.
          </div>
        </div>
      )}
