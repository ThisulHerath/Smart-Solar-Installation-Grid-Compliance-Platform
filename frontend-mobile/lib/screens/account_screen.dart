                ...
                child: Column(
                    ...
                    children: [
                      ...
                      if (_action == null) ...[
                        ...
                        if (_challenge != null) ...[
                          Text(
                              'Enter the code sent to $_email. It expires in 10 minutes.'),
                          SolarField(
                              controller: _code,
                              inputFormatters: [
                          ...
                          const Text(
                              'After verification, you will be signed out on every device.'),
                          SolarField(
                          ...
                          const Text(
                              'Your sign-in access and profile contact details will be removed permanently. Installation, survey, safety and approval records remain in the audit history. Deletion does not cancel an installation or erase information already in those records.'),
                          CheckboxListTile(
                              value: _acknowledged,
                              onChanged: _busy
                                  ? null
